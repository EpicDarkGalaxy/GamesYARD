...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy3.setHeightForWidth(self.grid_page.sizePolicy().hasHeightForWidth())
        self.grid_page.setSizePolicy(sizePolicy3)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 80, 28))
        ...
        sizePolicy3.setHeightForWidth(self.game_grid_container.sizePolicy().hasHeightForWidth())
        self.game_grid_container.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.details_page.sizePolicy().hasHeightForWidth())
        self.details_page.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.game_poster.sizePolicy().hasHeightForWidth())
        self.game_poster.setSizePolicy(sizePolicy4)
        ...
        sizePolicy2.setHeightForWidth(self.btn_get.sizePolicy().hasHeightForWidth())
        self.btn_get.setSizePolicy(sizePolicy2)
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 491, 179))
        ...
        self.requirments_grid = QGridLayout()
        self.requirments_grid.setObjectName(u"requirments_grid")

        self.verticalLayout_9.addLayout(self.requirments_grid)
