...
class GamePresenter():
    ...
    def bind_signals(self):
        ...
        PRESENTER_BRIDGE_SIGNALS.card_clicked_to_show.connect(self.on_card_clicked)
    ...
    def on_fetch_btn(self):
        ...
        if self.state.current_card is None:
            return
        providers, skip_providers_dict = self.create_provider_list(self.state.current_card)
